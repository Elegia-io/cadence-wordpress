...
final class CadenceAdmin {
    ...
    public static function screen(): void {
        ...
        // phpcs:ignore WordPress.Security.NonceVerification.Recommended -- a message this screen's own redirect set, read for display only, sanitized and escaped; it changes no state.
        if (!empty($_GET['error'])) {
