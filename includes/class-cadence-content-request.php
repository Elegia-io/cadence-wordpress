...
final class CadenceContentRequest {
    ...
    /**
     * @param int|null $author the byline the presenting key names, or null for
     *                 a key issued before a key named one
     * @return array{ok: bool, created?: bool, post_id?: int, report?: array,
     *               code?: string, reason?: string}
     */
    public static function run(array $body, ?int $author = null): array {
