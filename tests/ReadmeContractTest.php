 ...
 * the same codes in prose, for the person writing the caller, and nothing
 * binds the two automatically: a code can be added to the constant, the
 * status map and the fixture while the README table is left unchanged. This
 * test is that binding, so a documentation gap fails the build instead of
...
final class ReadmeContractTest extends TestCase {
    ...
    public function test_the_readme_status_beside_each_code_is_the_one_served(): void {
        ...
        // otherwise report a pass over nothing.
