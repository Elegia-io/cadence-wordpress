 ...
 *
 * WHY NOT JUST RUN IT AGAINST A REAL WPML. A self-hosted runner carrying
 * WordPress + WPML would need a machine to keep, patch and pay for, against a
 * plugin whose whole CI is two ten-minute jobs on GitHub's runners. It is a
 * price not yet paid, NOT an impossibility. Building that lane is not what
 * this file does.
 *
